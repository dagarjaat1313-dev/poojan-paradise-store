...
// Poojan Paradise ₹1,299 kit: exactly 15 products selected from the 25-product catalogue.
// Default contents total exactly ₹1,299.
const ITEMS=[
['Peela Kapda',75],['Lal Kapda',53],['Pooja Ghee',76],['Gobar Cups & Diya',95],['Bheem Seni Kapoor',261],
['Honey',66],['Dhoop Batti',44],['Perfume / Itra',44],['Mauli Kalava',15],['Cow Ghee Batti',95],
['Hawan Samagri',45],['Orange Sindoor',35],['Peeli Kaudi',95],['Gomti Chakra',75],['Rudraksh Mala',225]
];
const PRICE=1299;
