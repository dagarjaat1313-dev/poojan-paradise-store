...
// Poojan Paradise ₹1,299 kit: exactly 14 products selected from the catalogue.
// Default contents are the remaining kit essentials after Orange Sindoor removal.
const ITEMS=[
